...
export default function IntroClient({ greeting, name, introduction, location }) {
  ...
  return (
    ...
    <section id='intro' className='min-h-[90vh] flex flex-col justify-center py-32 max-w-5xl mx-auto'>
      <motion.div
        variants={container}
        initial="hidden"
        animate="show"
      ...
      >
        ...
        <motion.p variants={item} className='text-sm md:text-base font-medium tracking-[0.2em] uppercase text-zinc-500 dark:text-zinc-400' style={{ color: 'var(--accent-color)' }}>
          {greeting}
        </motion.p>
        ...
        <motion.p variants={item} className='text-xl md:text-3xl font-light text-zinc-600 dark:text-zinc-300 max-w-2xl leading-relaxed'>
          {introduction}
        </motion.p>
